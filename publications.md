...
**(1) Towards developing and fine-tuning trustworthy foundation models**: [[AAAI'25, *best paper award* at CoLoRAI]](#PrivateLoRA), [[NeurIPS'24]](#robust_alignment), [[ICLR'24 blogpost]](#ICLR24_blogpost), [[ICLR'24a]](#autoRFT), [[NeurIPS'23a, *spotlight*]](#NIPS23a), [[NeurIPS'23b]](#NIPS23b). <br/>
**(2) Towards evaluating and enhancing adversarial robustness of AI-powered applications (e.g., statistical tools, LLMs, diffusion models)**: [[ICML'24 challenge, *championship*]](#TiFA), [[ICLR'24b]](#promptattack), [[AAAI'24 workshop]](#AAAI24_ReLM), [[ICML'22]](#ICML22). <br/>
...
<br/> [<a href="https://arxiv.org/abs/2402.11989">PDF</a>] [<a href="https://github.com/WilliamLUO0/StablePrivateLoRA">Code</a>] [<a href="https://godxuxilie.github.io/file/best_paper_colorai.jpeg">Best paper award</a> at <a href="https://april-tools.github.io/colorai/">CoLoRAI</a>]
</li>
