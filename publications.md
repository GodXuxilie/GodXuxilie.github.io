...
**(1) Towards developing robust foundation models.**
...
**(2) Towards evaluating and enhancing robustness of AI-powered applications including statistical tools, large language models (LLMs), and diffusion models.**
...
**(3) Towards enhancing standard adversarial training.** 
